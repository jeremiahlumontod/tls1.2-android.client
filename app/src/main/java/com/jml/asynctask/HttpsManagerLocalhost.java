...
public class HttpsManagerLocalhost {
    ...
    public static String getDataBks(Context context, String uri) {
        ...
        try {
            ...
            ksTrust.load(context.getResources().openRawResource(R.raw.tomcatclient), passphrase);
